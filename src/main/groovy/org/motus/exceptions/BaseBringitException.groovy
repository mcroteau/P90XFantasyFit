...
class BaseBringitException extends GrailsExceptionResolver {
	
	BaseBringitException(){}
    ...
    ModelAndView resolveException(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
		...
		try{
			...
			def emailEncodedParam = "&m=" + URLEncoder.encode("Bringit Application", "UTF-8")
